...
http.createServer((req, res) => {
  ...
  if (req.method === 'GET' && (req.url === '/' || req.url === '/health')) return json(res, 200, { ok: true, service: 'thndr-plan', cpus: os.cpus().length, running, queued: queue.length, version: require('./package.json').version });
